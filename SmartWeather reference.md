### __SmartWeather__ - This is an example for backwards compatibility and reference **ONLY**
...
This is __my__ old SmartWeather config which uses five stations it may need some
changes to make it suitable for you. Or, it might work as it is.

I still use SmartWeather for Illuminance so that is included here too but plays no part in the irrigation package, I use it with my lights automations.
There is also a fallback Brightness sensor in here that I use when the SmartWeather stations went offline. It is less useful if you use several stations as I now do but it
is left here for completeness.

You can use any of it in your config if it is useful but please remember that I am only offering this file as a guide to help you.
